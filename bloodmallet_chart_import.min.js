...
function bloodmallet_chart_import() {
  ...
  function c(e, t, o, l) {
    ...
    try {
      ...
      return console.warn("Data for ", i, a, n, d, " wasn't loaded yet. Either chart setup is wrong, connection to bloodmallet.com is slow or failed."), void (l < 10 && setTimeout(c, 100, e, t, o, l + 1));
    }

    var u = p;
    var m, f;
    if (i.indexOf("azerite_traits") > -1) {
      if ("azerite_traits_stacking" === i) "all" === e.azerite_tier ? m = u.sorted_data_keys_2.slice(0, _) : "1" === e.azerite_tier || "3" === e.azerite_tier ? m = u.sorted_azerite_tier_3_trait_stacking.slice(0, _) : "2" === e.azerite_tier && (m = u.sorted_azerite_tier_2_trait_stacking.slice(0, _)), f = u.data.baseline[u.simulated_steps[0]];else {
        if ("azerite_traits_itemlevel" !== i) return void console.log("Chart found, but unknown data-type detected.");
        "all" === e.azerite_tier ? m = u.sorted_data_keys.slice(0, _) : "1" === e.azerite_tier || "3" === e.azerite_tier ? m = u.sorted_azerite_tier_3_itemlevel.slice(0, _) : "2" === e.azerite_tier && (m = u.sorted_azerite_tier_2_itemlevel.slice(0, _)), f = u.data.baseline[u.simulated_steps[u.simulated_steps.length - 1]];
      }
    } else m = u.sorted_data_keys.slice(0, _), f = "races" === i ? 0 : u.data.baseline[u.simulated_steps[u.simulated_steps.length - 1]];
    ...
    if ("azerite_traits_stacking" == i) {
      ...
      b.push("3_" + _e2), b.push("2_" + _e2), b.push("1_" + _e2);
    } else b = u.simulated_steps;

    if (r && console.log("simulated_steps: " + b), "essences" === i) {
      purge_list = [];
    ...
    if (r && console.log(y), "highcharts" == h ? o.update({
      xAxis: {
        categories: y
      }
    }, !1) : "highcharts_old" == h && o.xAxis[0].setCategories(y, !1), b) for (var _e4 = 0; _e4 < b.length; _e4++) {
      var _t3 = b[_e4];
      var w = [];
      ...
      for (var _o2 = 0; _o2 < m.length; _o2++) {
        ...
        Number(_a[_t3]) > 0 ? _e4 == b.length - 1 ? _t3 in _a ? w.push(_a[_t3] - f) : w.push(0) : 0 !== _a[_l2[String(Number(_e4) + 1)]] && _l2[String(Number(_e4) + 1)] in _a ? w.push(_a[_t3] - _a[_l2[String(Number(_e4) + 1)]]) : w.push(_a[_t3] - f) : _t3 in _a ? w.push(_a[_t3]) : w.push(0);
      }
  ...
  function g(e, t, o) {
    ...
    if ("wowhead" == e.tooltip_engine) {
      ...
      if (_i.href = "https://" + ("en" === e.language ? "www" : e.language) + ".wowhead.com/", o.hasOwnProperty("power_ids") && o.power_ids.hasOwnProperty(t)) _i.href += "azerite-essence-power/" + o.power_ids[t];else if (o.hasOwnProperty("item_ids") && o.item_ids.hasOwnProperty(t)) {
        if (_i.href += "item=" + o.item_ids[t] + "/" + _(t), o.hasOwnProperty("class_id") && o.hasOwnProperty("used_azerite_traits_per_item")) {
      ...
      } else o.hasOwnProperty("spell_ids") && o.spell_ids.hasOwnProperty(t) && (_i.href += "spell=" + o.spell_ids[t] + "/" + _(t));
  ...
  this.init_charts = new function () {
    ...
    for (var _t7 = 0; _t7 < e.length; _t7++) {
      var _o5 = e[_t7];
      if (i.indexOf(_o5.id) > -1) return void console.error("Multiple Elements use the same ID ('" + _o5.id + "'). Aborting bloodmallet_chart_import.js.");
      i.push(_o5.id);
    }
    ...
    for (var _i4 = 0; _i4 < e.length; _i4++) {
      ...
      try {
        ...
        return void console.log("No bloodmallet_chart was found.");
      }

      var _g = document.getElementById(e[_i4].id);
      ...
      if (_g) {
        ...
        try {
          void 0 !== bloodmallet.style.axis_color && (a.axis_color = bloodmallet.style.axis_color), void 0 !== bloodmallet.style.background_color && (a.background_color = bloodmallet.style.background_color), void 0 !== bloodmallet.style.font_color && (a.font_color = bloodmallet.style.font_color), void 0 !== bloodmallet.settings.entries && (a.data_entries = bloodmallet.settings.entries), void 0 !== bloodmallet.settings.chart_engine && (a.chart_engine = bloodmallet.settings.chart_engine), void 0 !== bloodmallet.settings.tooltip_engine && (a.tooltip_engine = bloodmallet.settings.tooltip_engine), void 0 !== bloodmallet.settings.language && (a.language = bloodmallet.settings.language);
        } catch (e) {
          r && console.log("Applying page wide settings failed.");
        }

        _g.getAttribute("data-entries") && (a.data_entries = _g.getAttribute("data-entries")), _g.getAttribute("data-fight-style") && (a.fight_style = _g.getAttribute("data-fight-style")), _g.getAttribute("data-type") && (a.data_type = _g.getAttribute("data-type")), _g.getAttribute("data-azerite-tier") && (a.azerite_tier = _g.getAttribute("data-azerite-tier")), _g.getAttribute("data-background-color") && (a.background_color = _g.getAttribute("data-background-color")), _g.getAttribute("data-font-color") && (a.font_color = _g.getAttribute("data-font-color")), _g.getAttribute("data-axis-color") && (a.axis_color = _g.getAttribute("data-axis-color")), _g.getAttribute("data-tooltip-engine") && (a.tooltip_engine = _g.getAttribute("data-tooltip-engine")), _g.getAttribute("data-chart-engine") && (a.chart_engine = _g.getAttribute("data-chart-engine")), _g.getAttribute("data-language") && (a.language = _g.getAttribute("data-language")), _g.getAttribute("data-filter-essence-types") && (a.filters.essence_types = _g.getAttribute("data-filter-essence-types").split(";"));

        var _e12 = !0;

        _g.getAttribute("data-wow-class") || (console.log("Required 'data-wow-class' attribute wasn't found in " + _s2 + "."), _e12 = !1), a.wow_class = _g.getAttribute("data-wow-class"), _g.getAttribute("data-wow-spec") || (console.log("Required 'data-wow-spec' attribute wasn't found in " + _s2 + "."), _e12 = !1), a.wow_spec = _g.getAttribute("data-wow-spec");

        var _i5 = h(a),
            _2 = !1;

        if ("highcharts" == a.chart_engine) try {
          _2 = Highcharts.chart(_s2, _i5);
        } catch (e) {
        ...
        } else if ("highcharts_old" == a.chart_engine) try {
          var _e13 = _i5;
          _e13.chart.renderTo = _s2, _2 = new Highcharts.Chart(_e13);
        } catch (e) {
