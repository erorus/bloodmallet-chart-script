...
function bloodmallet_chart_import() {
  ...
  function g(e, t, o, l) {
    ...
    if (!0 === u.error || "error" === u.status) return function (e, t) {
      var o = e;
    ...
    if (wow_class = u.simc_settings.class, wow_spec = u.simc_settings.spec, fight_style = u.simc_settings.fight_style, e.data_type = a = u.data_type, "soulbinds" === a && (e.conduit_rank = Math.max.apply(Math, _toConsumableArray(u.simulated_steps)).toString()), function (e, t) {
      ...
      "talents" === e.data_type && (document.getElementById("talent-warning").hidden = !1, function (e, t) {
        ...
        for (var _i2 = 0; _i2 < o.length; _i2++) {
          ...
          try {
            ...
            _a3.innerHTML = N(e, _i3.name, _l6, t), _o5.innerHTML = "", _o5.appendChild(_a3), _o5.appendChild(I("Mean", P(_l6, t))), _o5.appendChild(I("Min", D(_l6, t)[1], D(_l6, t)[0])), _o5.appendChild(I("Max", B(_l6, t)[1], B(_l6, t)[0]));
        ...
        try {
          for (var _iterator4 = _a5[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            _i5.className = " form-check-label", _i5.htmlFor = _t4, _i5.appendChild(document.createTextNode(_e8)), _a7.appendChild(_i5), _l9.appendChild(_a7), _n6.addEventListener("change", function (e, t) {
              O(e.target.value, e.target.checked), bloodmallet_chart_import();
            });
          }
        } catch (err) {
      ...
      var b = s.timestamp,
          ...
          k = b.split(":")[1],
          A = "Last updated ",
          L = new Date() - new Date(Date.UTC(y, v - 1, w, x, k)),
          T = Math.floor(L / 24 / 3600 / 1e3);
      T > 0 && (A += "".concat(T, "d "));
      var O = Math.floor(L / 3600 / 1e3) - 24 * T;
      A += "".concat(O, "h ago"), o.redraw(), function (e) {
        function t(t) {
    ...
    var b,
        y,
        v = {};
    b = "soulbinds" === a ? "nodes" === e.chart_mode ? p["sorted_data_keys_" + L(e.covenant).replace("-", "_") + "_" + e.conduit_rank].slice(0, i) : p.sorted_data_keys[e.conduit_rank].slice(0, i) : p.sorted_data_keys.slice(0, i), y = ["races", "talents"].includes(a) ? 0 : ["soulbinds"].includes(a) && "nodes" === e.chart_mode ? p.data.baseline[e.covenant] : ["legendaries", "soulbind_nodes", "soulbinds", "covenants", "domination_shards"].includes(a) ? p.data.baseline : p.data.baseline[p.simulated_steps[p.simulated_steps.length - 1]];

    var _arr2 = Object.keys(p.data);

    for (var _i8 = 0; _i8 < _arr2.length; _i8++) {
      var _e14 = _arr2[_i8];
      "{" === _e14[0] && "}" === _e14[_e14.length - 1] && (v[_e14] = p.data[_e14]);
    }

    n && (console.log(b), console.log("Baseline dps: " + y), console.log("other baseline dps: " + v));
    var S = [];

    if (S = "soulbinds" == a && "soulbinds" === e.chart_mode ? void 0 : p.simulated_steps, n && console.log("simulated_steps: " + S), "soulbinds" === a && "nodes" !== e.chart_mode && (b = x(e, _(e, p), p)), "trinkets" === a) {
    ...
    if (j = "talents" === a ? b.map(function (t) {
      var o = [];
      ...
      for (var _o12 in p.data) {
        if (p.data.hasOwnProperty(_o12)) {
          ...
          for (var _a9 = S.length - 1; _a9 >= 0; _a9--) {
            ...
            var _r5 = _l13.hasOwnProperty(e.covenant) ? _l13[e.covenant] : _l13;

            Number.isInteger(_r5) ? (_t11[_o12][_i9] = _r5 - _n8, _n8 = _r5) : _r5.hasOwnProperty(_i9) ? (_t11[_o12][_i9] = _r5[_i9] - _n8, _n8 = _r5[_i9]) : _t11[_o12][_i9] = 0;
          }
        }
      }
      ...
      try {
        for (var _iterator7 = S[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          ...
          for (var _o13 = 0; _o13 < b.length; _o13++) {
            var _a10 = b[_o13];

            _n9.push(k(e, _t11[_a10][_l14], y));
          }

          var _i10 = _l14;
          "soulbinds" === a && "nodes" === e.chart_mode && (_i10 = d[_i10]), o.addSeries({
            data: _n9,
            name: _i10
          }, !1);
        }
      ...
      for (var _t12 = 0; _t12 < b.length; _t12++) {
        var _o14 = b[_t12],
            _l15 = p.data[_o14] - y;
      ...
      try {
        for (var _iterator8 = b[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
          ...
          if (_o15.indexOf("} ") > -1) {
            ...
            _n11 = v[_t14], _a11[_t14].push(k(e, _n11, y));

            var _arr5 = Object.keys(_a11);

            for (var _i14 = 0; _i14 < _arr5.length; _i14++) {
              var _e12 = _arr5[_i14];
              _e12 !== _t14 && _a11[_e12].push(0);
            }
          } else {
          ...
          var _i13 = p.data[_o15] - _n11;

          _t13.push(k(e, _i13, _n11));
        }
      } catch (err) {
      ...
      for (var _i12 = 0; _i12 < _arr4.length; _i12++) {
        ...
        o.addSeries({
          data: _a11[_e13],
          name: _n10[_e13.slice(1, _e13.length - 1)],
          showInLegend: !0,
          color: s[_n10[_e13.slice(1, _e13.length - 1)]].color
        }, !1);
      }
      ...
      try {
        for (var _iterator11 = Object.keys(s).sort().reverse()[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
          ...
          for (var _t20 = 0; _t20 < b.length; _t20++) {
            var _o18 = b[_t20],
                _n13 = 0;
      ...
      for (var _t21 = 0; _t21 < b.length; _t21++) {
        var _o19 = b[_t21],
            _l20 = p.data[_o19];
    ...
    ["trinkets"].indexOf(a) > -1 ? o.legend.title.attr({
      ...
      text: "Conduit Rank"
    }), o.redraw(), "highcharts_old" == r && o.reflow(), t.style.height = 200 + 30 * b.length + "px", "highcharts" == r && o.setSize(t.style.width, t.style.height), "wowdb" == e.tooltip_engine && setTimeout(function () {
      !function (e) {
  ...
  function C(e, t, o) {
    ...
    for (var _e15 = 0; _e15 < 3; _e15++) {
      r += Math.abs(i[_e15] - a[_e15]), s += Math.abs(a[_e15] - l[_e15]);
    }
  ...
  function A(e, t, o) {
    ...
    if ("wowhead" == e.tooltip_engine) {
      ...
      if (_l22.href = "https://" + ("en" === e.language ? "www" : e.language) + ".wowhead.com/", o.hasOwnProperty("item_ids") && o.item_ids.hasOwnProperty(t)) {
        if (_l22.href += "item=" + o.item_ids[t] + "/" + L(t), void 0 !== o.simulated_steps) {
          ...
          "string" == typeof _e16 && _e16.indexOf("_") > -1 && (_e16 = _e16.split("_")[1]), _l22.href += "&ilvl=" + _e16;
        }
    ...
    if ("wowdb" == e.tooltip_engine) {
      ...
      if (_l23.href.indexOf("items") > -1) {
        ...
        "string" == typeof _e17 && _e17.indexOf("_") > -1 && (_e17 = _e17.split("_")[1]), _l23.href += "?itemLevel=" + _e17;
      }
  ...
  function E(i) {
    if (n && console.log("update_chart_style"), "highcharts" == i.chart_engine || "highcharts_old" == i.chart_engine) {
      ...
      return _c4.chart.backgroundColor = _n14, _c4.legend.backgroundColor = _n14, _c4.legend.borderColor = _r6, _c4.legend.itemStyle.color = _s3, _c4.legend.itemHoverStyle.color = _s3, _c4.title.style.color = _s3, _c4.subtitle.style.color = _s3, _c4.tooltip.formatter = function () {
        ...
        for (var a = this.points.length - 1; a >= 0; a--) {
          if (l += this.points[a].y, 0 !== this.points[a].y) {
            ...
            _t25.appendChild(_o21), _o21.style.marginLeft = "9px", _o21.style.borderLeft = "9px solid " + this.points[a].series.color, _o21.style.paddingLeft = "4px", Number.isInteger(this.points[a].series.name) && _o21.appendChild(document.createTextNode(this.points[a].series.name + ":")), _t25.appendChild(document.createTextNode("  " + Intl.NumberFormat().format(l) + ("relative" !== i.value_style || "soulbinds" === i.data_type && "soulbinds" === i.chart_mode ? "" : "%")));
          }
        }

        return e.outerHTML;
      }, _c4.tooltip.backgroundColor = "transparent" !== _n14 ? _n14 : t, _c4.tooltip.borderColor = _r6, _c4.tooltip.style.color = _s3, _c4.xAxis.labels.style.color = _s3, _c4.xAxis.gridLineColor = _r6, _c4.xAxis.lineColor = _r6, _c4.xAxis.tickColor = _r6, _c4.yAxis[0].labels.style.color = _r6, _c4.yAxis[0].stackLabels.style.color = _s3, _c4.yAxis[0].gridLineColor = _r6, _c4.yAxis[0].lineColor = _r6, _c4.yAxis[0].tickColor = _r6, _c4.yAxis[0].title.style.color = _r6, _c4.yAxis[1].labels.style.color = _r6, _c4.yAxis[1].stackLabels.style.color = _s3, _c4.yAxis[1].gridLineColor = _r6, _c4.yAxis[1].lineColor = _r6, _c4.yAxis[1].tickColor = _r6, _c4.yAxis[1].title.style.color = _r6, _c4.credits.style.color = _s3, _c4;
    }
  }
  ...
  function I(e, t, o) {
    ...
    if (a.innerHTML = t + "%", a.classList += S(t >= 0 ? t : 3 - t), void 0 !== o) {
      ...
      var _e18 = document.createElement("span");

      _e18.classList += "priest-color", _e18.innerHTML = " (?)", a.appendChild(_e18);
    }
  ...
  function M(e, t) {
    ...
    try {
      for (var _iterator12 = t.sorted_data_keys[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
        var _o22 = _step12.value;
  ...
  function D(e, t) {
    ...
    try {
      for (var _iterator13 = t.sorted_data_keys[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
        ...
        if (_e19[o - 1] === l) {
          var _l24 = t.data[_e19],
              _i17 = t.data[_e19.slice(0, o - 1) + "0" + _e19.slice(o, 8)];

          a > F(_i17, _l24) && (a = F(_i17, _l24), n = _e19);
        }
      }
    } catch (err) {
  ...
  function B(e, t) {
    ...
    try {
      for (var _iterator14 = t.sorted_data_keys[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
        ...
        if (_e20[o - 1] === l) {
          var _l25 = t.data[_e20],
              _i18 = t.data[_e20.slice(0, o - 1) + "0" + _e20.slice(o, 8)];

          a < F(_i18, _l25) && (a = F(_i18, _l25), n = _e20);
        }
      }
    } catch (err) {
  ...
  function P(e, t) {
    ...
    for (var _i19 = 0; _i19 < o.length; _i19++) {
      ...
      l += F(t.data[_a16.slice(0, e.slice(0, 1) - 1) + "0" + _a16.slice(e.slice(0, 1), 8)], _o23);
    }
  ...
  this.init_charts = new function () {
    ...
    for (var _a17 = 0; _a17 < e.length; _a17++) {
      ...
      if (_r7) {
        ...
        try {
          void 0 !== bloodmallet.style.axis_color && (_e21.axis_color = bloodmallet.style.axis_color), void 0 !== bloodmallet.style.background_color && (_e21.background_color = bloodmallet.style.background_color), void 0 !== bloodmallet.style.font_color && (_e21.font_color = bloodmallet.style.font_color), void 0 !== bloodmallet.settings.entries && (_e21.limit = bloodmallet.settings.entries), void 0 !== bloodmallet.settings.chart_engine && (_e21.chart_engine = bloodmallet.settings.chart_engine), void 0 !== bloodmallet.settings.tooltip_engine && (_e21.tooltip_engine = bloodmallet.settings.tooltip_engine), void 0 !== bloodmallet.settings.language && (_e21.language = bloodmallet.settings.language), void 0 !== bloodmallet.settings.value_style && (_e21.value_style = bloodmallet.settings.value_style);
        } catch (e) {
          n && console.log("Applying page wide settings failed or no page wide settings were found.");
        }

        _r7.getAttribute("data-entries") && (_e21.limit = _r7.getAttribute("data-entries")), _r7.getAttribute("data-fight-style") && (_e21.fight_style = _r7.getAttribute("data-fight-style")), _r7.getAttribute("data-type") && (_e21.data_type = _r7.getAttribute("data-type")), _r7.getAttribute("data-chart-mode") && (_e21.chart_mode = _r7.getAttribute("data-chart-mode")), _r7.getAttribute("data-covenant") && (_e21.covenant = _r7.getAttribute("data-covenant")), _r7.getAttribute("data-renown") && (_e21.renown = _r7.getAttribute("data-renown")), _r7.getAttribute("data-conduit-rank") && (_e21.conduit_rank = _r7.getAttribute("data-conduit-rank")), _r7.getAttribute("data-background-color") && (_e21.background_color = _r7.getAttribute("data-background-color")), _r7.getAttribute("data-font-color") && (_e21.font_color = _r7.getAttribute("data-font-color")), _r7.getAttribute("data-axis-color") && (_e21.axis_color = _r7.getAttribute("data-axis-color")), _r7.getAttribute("data-tooltip-engine") && (_e21.tooltip_engine = _r7.getAttribute("data-tooltip-engine")), _r7.getAttribute("data-chart-engine") && (_e21.chart_engine = _r7.getAttribute("data-chart-engine")), _r7.getAttribute("data-language") && (_e21.language = _r7.getAttribute("data-language")), _r7.getAttribute("data-value-style") && (_e21.value_style = _r7.getAttribute("data-value-style"));

        var _a18 = !0;

        _r7.getAttribute("data-chart-id") ? _e21.chart_id = _r7.getAttribute("data-chart-id") : (_r7.getAttribute("data-wow-class") || (console.error("Required 'data-chart-id' or 'data-wow-class' attribute wasn't found in " + _i20 + "."), _a18 = !1), _e21.wow_class = _r7.getAttribute("data-wow-class"), _r7.getAttribute("data-wow-spec") || (console.error("Required 'data-chart-id' or 'data-wow-spec' attribute wasn't found in " + _i20 + "."), _a18 = !1), _e21.wow_spec = _r7.getAttribute("data-wow-spec"));

        var _s4 = E(_e21),
            _d5 = !1;

        if ("highcharts" == _e21.chart_engine) try {
          _d5 = Highcharts.chart(_i20, _s4);
        } catch (e) {
          return console.log("When trying to create a highcharts chart the following error occured. Did you include the necessary Highcharts scripts?"), void console.log(e);
        } else if ("highcharts_old" == _e21.chart_engine) try {
          var _e22 = _s4;
          _e22.chart.renderTo = _i20, _d5 = new Highcharts.Chart(_e22);
        } catch (e) {
          return console.log("When trying to create a highcharts_old chart the following error occured. Did you include the necessary Highcharts scripts?"), void console.log(e);
        }
        _a18 ? p(_e21) : _d5.setTitle({
