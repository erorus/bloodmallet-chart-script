...
function bloodmallet_chart_import() {
  ...
  function g(e, t, o, l) {
    ...
    if (wow_class = u.simc_settings.class, wow_spec = u.simc_settings.spec, fight_style = u.simc_settings.fight_style, e.data_type = a = u.data_type, "soulbinds" === a && (e.conduit_rank = Math.max.apply(Math, _toConsumableArray(u.simulated_steps)).toString()), function (e, t) {
      ...
      "talents" === e.data_type && (document.getElementById("talent-warning").hidden = !1, function (e, t) {
        ...
        for (var _i2 = 0; _i2 < o.length; _i2++) {
          ...
          try {
            ...
            _a3.innerHTML = N(e, _i3.name, _l6, t), _o5.innerHTML = "", _o5.appendChild(_a3), _o5.appendChild(I("Mean", B(_l6, t))), _o5.appendChild(I("Min", D(_l6, t)[1], D(_l6, t)[0])), _o5.appendChild(I("Max", P(_l6, t)[1], P(_l6, t)[0]));
      ...
      var l = t.id,
          ...
          r = e.wow_spec,
          s = (e.chart_engine, !1);
      s = p(e), i = s.simc_settings.class, r = s.simc_settings.spec, a = s.simc_settings.fight_style;
      var d = E(e),
          c = !1;
    ...
    var y,
        b,
        v = {};
    y = "soulbinds" === a ? "nodes" === e.chart_mode ? (y = m["sorted_data_keys_" + L(e.covenant).replace("-", "_") + "_" + e.conduit_rank].slice(0, i)).map(function (t) {
      return [t, Math.max.apply(Math, _toConsumableArray(m.simulated_steps.map(function (o) {
        return Number.isInteger(m.data[t][e.covenant]) ? m.data[t][e.covenant] : m.data[t][e.covenant][o] || 0;
      })))];
    }).sort(function (e, t) {
      return t[1] - e[1];
    }).map(function (e) {
      return e[0];
    }) : m.sorted_data_keys[e.conduit_rank].slice(0, i) : m.sorted_data_keys.slice(0, i), b = ["races", "talents"].includes(a) ? 0 : ["soulbinds"].includes(a) && "nodes" === e.chart_mode ? m.data.baseline[e.covenant] : ["legendaries", "soulbind_nodes", "soulbinds", "covenants", "domination_shards"].includes(a) ? m.data.baseline : m.data.baseline[m.simulated_steps[m.simulated_steps.length - 1]];

    var _arr2 = Object.keys(m.data);

    for (var _i8 = 0; _i8 < _arr2.length; _i8++) {
      var _e15 = _arr2[_i8];
      "{" === _e15[0] && "}" === _e15[_e15.length - 1] && (v[_e15] = m.data[_e15]);
    }

    n && (console.log(y), console.log("Baseline dps: " + b), console.log("other baseline dps: " + v));
    var S = [];

    if (S = "soulbinds" == a && "soulbinds" === e.chart_mode ? void 0 : m.simulated_steps, n && console.log("simulated_steps: " + S), "soulbinds" === a && "nodes" !== e.chart_mode && (y = x(e, _(e, m), m)), "trinkets" === a) {
      ...
      if (y = y.filter(function (e) {
        ...
        _t8.map(function (e) {
          ...
          return -1 === _o10.indexOf(m.data_active[e]);
        });
      }
      ...
      if (void 0 !== e.html_element.dataset.filterSources) {
        ...
        y = y.filter(function (e) {
          return -1 === _t9.indexOf(m.data_sources[e]);
        });
      }
        ...
        for (var _iterator5 = y[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          ...
          try {
            for (var _iterator6 = S[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
              ...
              void 0 === _o11 && void 0 !== m.data[_e10][_t10] && (_o11 = m.data[_e10][_t10]);
            }
          } catch (err) {
    ...
    if (j = "talents" === a ? y.map(function (t) {
      ...
      for (var _l12 = 0; _l12 < t.length; _l12++) {
        o.push(A(e, (_l12 + 1).toString() + t[_l12], m));
      }

      return o.join("");
    }) : y.map(function (t) {
      var o = t.indexOf("} ") > -1 ? t.slice(t.indexOf("} ") + 2, t.length) : t;
      return o = o.indexOf(" +") > -1 ? o.slice(0, o.indexOf(" +")) : o, A(e, o, m);
      ...
      for (var _o12 in m.data) {
        if (m.data.hasOwnProperty(_o12)) {
          var _l13 = m.data[_o12];
          _t11[_o12] = {};
          var _n8 = b;
          "conduits" === a ? _n8 = m.data.baseline[m.covenant_mapping[_o12]] : "soulbinds" === a && "nodes" === e.chart_mode && (_n8 = m.data.baseline[e.covenant]);
      ...
      var _t13 = [],
          _l16 = "{" + m.profile.character.covenant + "}",
          _a11 = {};
      ...
      for (var _i15 = 0; _i15 < _arr7.length; _i15++) {
        ...
        try {
          for (var _iterator10 = y[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
            ...
            if (_o17.indexOf(" +") > -1 && (_a13 = _o17.split(" +")[0], _n12 = m.data[_a13]), m.shard_type[_a13] === _t17) {
              var _t18 = m.data[_o17] - _n12;
      ...
      try {
        for (var _iterator11 = Object.keys(s).sort().reverse()[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
          ...
          for (var _t20 = 0; _t20 < y.length; _t20++) {
            var _o18 = y[_t20],
                _n13 = 0;
            m.covenant_mapping[_o18][0] === _l19 && (_n13 = f(e, _o18, m)), _a14.push(_n13);
          }
      ...
      for (var _t21 = 0; _t21 < y.length; _t21++) {
        var _o19 = y[_t21],
            _l20 = m.data[_o19];
        "soulbinds" === a && (_l20 = m.data[_o19][e.conduit_rank]), z.push(_l20);
      }
        ...
        for (var a = this.points.length - 1; a >= 0; a--) {
          ...
          try {
            for (var _iterator12 = this.points[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
              ...
              0 !== _e19.y && 0 !== _o21 && _o21 !== _e19.y ? _t25 = !0 : 0 !== _e19.y && 0 === _o21 && (_o21 = _e19.y);
            }
          } catch (err) {
          ...
          if (0 !== this.points[a].y || _t25 && "soulbinds" === i.data_type && "nodes" === i.chart_mode) {
            ...
            _t26.appendChild(_o22), _o22.style.marginLeft = "9px", _o22.style.borderLeft = "9px solid " + this.points[a].series.color, _o22.style.paddingLeft = "4px", Number.isInteger(this.points[a].series.name) && _o22.appendChild(document.createTextNode(this.points[a].series.name + ":")), _t26.appendChild(document.createTextNode("  " + Intl.NumberFormat().format(l) + ("relative" !== i.value_style || "soulbinds" === i.data_type && "soulbinds" === i.chart_mode || "races" === i.data_type ? "" : "%")));
          }
        }
  ...
  function I(e, t, o) {
    ...
    if (a.innerHTML = t + "%", a.classList += S(t >= 0 ? t : 3 - t), void 0 !== o) {
      ...
      var _e20 = document.createElement("span");

      _e20.classList += "priest-color", _e20.innerHTML = " (?)", a.appendChild(_e20);
    }
  ...
  function D(e, t) {
    ...
    try {
      for (var _iterator14 = t.sorted_data_keys[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
        ...
        if (_e21[o - 1] === l) {
          var _l24 = t.data[_e21],
              _i16 = t.data[_e21.slice(0, o - 1) + "0" + _e21.slice(o, 8)];

          a > F(_i16, _l24) && (a = F(_i16, _l24), n = _e21);
        }
      }
    } catch (err) {
  ...
  function P(e, t) {
    ...
    try {
      for (var _iterator15 = t.sorted_data_keys[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
        var _e22 = _step15.value;

        if (_e22[o - 1] === l) {
          var _l25 = t.data[_e22],
              _i17 = t.data[_e22.slice(0, o - 1) + "0" + _e22.slice(o, 8)];

          a < F(_i17, _l25) && (a = F(_i17, _l25), n = _e22);
        }
      }
    } catch (err) {
  ...
  function B(e, t) {
    ...
    for (var _i18 = 0; _i18 < o.length; _i18++) {
      var _a16 = _o24[_i18];
  ...
  this.init_charts = new function () {
    ...
    for (var _a17 = 0; _a17 < e.length; _a17++) {
      ...
      var _r6 = document.getElementById(e[_a17].id);
      ...
      if (_r6) {
        ...
        try {
          void 0 !== bloodmallet.style.axis_color && (_e23.axis_color = bloodmallet.style.axis_color), void 0 !== bloodmallet.style.background_color && (_e23.background_color = bloodmallet.style.background_color), void 0 !== bloodmallet.style.font_color && (_e23.font_color = bloodmallet.style.font_color), void 0 !== bloodmallet.settings.entries && (_e23.limit = bloodmallet.settings.entries), void 0 !== bloodmallet.settings.chart_engine && (_e23.chart_engine = bloodmallet.settings.chart_engine), void 0 !== bloodmallet.settings.tooltip_engine && (_e23.tooltip_engine = bloodmallet.settings.tooltip_engine), void 0 !== bloodmallet.settings.language && (_e23.language = bloodmallet.settings.language), void 0 !== bloodmallet.settings.value_style && (_e23.value_style = bloodmallet.settings.value_style);
        } catch (e) {
          n && console.log("Applying page wide settings failed or no page wide settings were found.");
        }

        _r6.getAttribute("data-entries") && (_e23.limit = _r6.getAttribute("data-entries")), _r6.getAttribute("data-fight-style") && (_e23.fight_style = _r6.getAttribute("data-fight-style")), _r6.getAttribute("data-type") && (_e23.data_type = _r6.getAttribute("data-type")), _r6.getAttribute("data-chart-mode") && (_e23.chart_mode = _r6.getAttribute("data-chart-mode")), _r6.getAttribute("data-covenant") && (_e23.covenant = _r6.getAttribute("data-covenant")), _r6.getAttribute("data-renown") && (_e23.renown = _r6.getAttribute("data-renown")), _r6.getAttribute("data-conduit-rank") && (_e23.conduit_rank = _r6.getAttribute("data-conduit-rank")), _r6.getAttribute("data-background-color") && (_e23.background_color = _r6.getAttribute("data-background-color")), _r6.getAttribute("data-font-color") && (_e23.font_color = _r6.getAttribute("data-font-color")), _r6.getAttribute("data-axis-color") && (_e23.axis_color = _r6.getAttribute("data-axis-color")), _r6.getAttribute("data-tooltip-engine") && (_e23.tooltip_engine = _r6.getAttribute("data-tooltip-engine")), _r6.getAttribute("data-chart-engine") && (_e23.chart_engine = _r6.getAttribute("data-chart-engine")), _r6.getAttribute("data-language") && (_e23.language = _r6.getAttribute("data-language")), _r6.getAttribute("data-value-style") && (_e23.value_style = _r6.getAttribute("data-value-style"));

        var _a18 = !0;

        _r6.getAttribute("data-chart-id") ? _e23.chart_id = _r6.getAttribute("data-chart-id") : (_r6.getAttribute("data-wow-class") || (console.error("Required 'data-chart-id' or 'data-wow-class' attribute wasn't found in " + _i19 + "."), _a18 = !1), _e23.wow_class = _r6.getAttribute("data-wow-class"), _r6.getAttribute("data-wow-spec") || (console.error("Required 'data-chart-id' or 'data-wow-spec' attribute wasn't found in " + _i19 + "."), _a18 = !1), _e23.wow_spec = _r6.getAttribute("data-wow-spec"));

        var _s4 = E(_e23),
            _d5 = !1;

        if ("highcharts" == _e23.chart_engine) try {
          _d5 = Highcharts.chart(_i19, _s4);
        } catch (e) {
          return console.log("When trying to create a highcharts chart the following error occured. Did you include the necessary Highcharts scripts?"), void console.log(e);
        } else if ("highcharts_old" == _e23.chart_engine) try {
          var _e24 = _s4;
          _e24.chart.renderTo = _i19, _d5 = new Highcharts.Chart(_e24);
        } catch (e) {
          return console.log("When trying to create a highcharts_old chart the following error occured. Did you include the necessary Highcharts scripts?"), void console.log(e);
        }
        _a18 ? m(_e23) : _d5.setTitle({
