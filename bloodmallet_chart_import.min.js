...
function bloodmallet_chart_import() {
  ...
  function d(e) {
    ...
    r && console.log("Fetching data from: " + h), u.open("GET", h, !0), u.onload = function (t) {
  ...
  function h(e, t, o, a) {
    ...
    try {
      ...
      return void (a < 30 && setTimeout(h, 200, e, t, o, a + 1));
    }

    if (!0 === L.error) return function (e, t) {
      var o = e;
      o.innerHTML = "";
    ...
    if (d = L.simc_settings.class, y = L.simc_settings.spec, i = L.simc_settings.fight_style, e.data_type = l = L.data_type, function (e, t) {
      ...
      "talents" === e.data_type && (document.getElementById("talent-warning").hidden = !1, function (e, t) {
        ...
        for (var _i = 0; _i < o.length; _i++) {
          ...
          try {
            ...
            _l2.innerHTML = w(e, _i2.name, _a5, t), _o5.innerHTML = "", _o5.appendChild(_l2), _o5.appendChild(f("Mean", k(_a5, t))), _o5.appendChild(f("Min", v(_a5, t)[1], v(_a5, t)[0])), _o5.appendChild(f("Max", C(_a5, t)[1], C(_a5, t)[0]));
            ...
            _o5.appendChild(f("Max dps", T(_c, _d), _n)), _n = b(_a5, t);

            var _h = T(t.data[t.sorted_data_keys[0]], t.data[_n]);

            _o5.appendChild(f("Max dps minus global best", _h, _n));
          } catch (e) {
      ...
      if ("soulbinds" === e.data_type) {
        ...
        _o6.hidden = !1, _o6.innerHTML = "", Object.keys(t.covenant_ids).forEach(function (a) {
          ...
          r.appendChild(document.createTextNode(x(a, t))), _o6.appendChild(r);
          var i = 0;
          ...
          try {
            for (var _iterator = t.sorted_data_keys[t.simulated_steps[0]][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              if (t.covenant_mapping[_a6].indexOf(l) > -1) {
                ...
                _l3.appendChild(document.createTextNode(i + ". " + x(_a6, t))), _l3.classList += "ml-3", _l3.id = _a6, _o6.appendChild(_l3);
                ...
                try {
                  for (var _iterator2 = t.soul_bind_paths[t.simulated_steps[0]][_a6][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    if (t.data.hasOwnProperty(_o7)) {
                      ...
                      _a7.href = "https://" + ("en" === e.language ? "www" : e.language) + ".wowhead.com/", t.hasOwnProperty("spell_ids") && t.spell_ids.hasOwnProperty(_o7) && (_a7.href += "spell=" + t.spell_ids[_o7] + "/" + _(_o7)), _a7.appendChild(document.createTextNode(t.translations[_o7][n[e.language]])), _s2.push(_a7);
                    }
                  }
                } catch (err) {
                ...
                for (var _e4 = 0; _e4 < _s2.length; _e4++) {
                  0 !== _e4 && _r3.appendChild(document.createTextNode(", ")), _r3.appendChild(_s2[_e4]);
                }
    ...
    }(e, L), "secondary_distributions" === l) return function (e, t, o) {
      ...
      var a = t.id,
          ...
          n = e.wow_spec,
          s = (e.chart_engine, !1);
      s = c(e), i = s.simc_settings.class, n = s.simc_settings.spec, l = s.simc_settings.fight_style;
      var d = m(e),
          h = !1;
      if ("highcharts" == e.chart_engine) try {
        h = Highcharts.chart(a, d);
      } catch (e) {
      ...
      for (var _i3 = 0; _i3 < _arr.length; _i3++) {
        ...
        p === _o8 && (_l4 = 3, _i4 = 8, _r4 = e.font_color);
    ...
    "azerite_traits" === L.data_type ? -1 === l.indexOf("azerite_items") && (l = "azerite_traits_stacking") : l = L.data_type;
    var z = L;
    var M, I;
    if (l.indexOf("azerite_traits") > -1) {
      if ("azerite_traits_stacking" === l) "all" === e.azerite_tier ? M = z.sorted_data_keys_2.slice(0, A) : "1" === e.azerite_tier || "3" === e.azerite_tier ? M = z.sorted_azerite_tier_3_trait_stacking.slice(0, A) : "2" === e.azerite_tier && (M = z.sorted_azerite_tier_2_trait_stacking.slice(0, A)), I = z.data.baseline[z.simulated_steps[0]];else {
        if ("azerite_traits_itemlevel" !== l) return void console.log("Chart found, but unknown data-type detected.");
        "all" === e.azerite_tier ? M = z.sorted_data_keys.slice(0, A) : "1" === e.azerite_tier || "3" === e.azerite_tier ? M = z.sorted_azerite_tier_3_itemlevel.slice(0, A) : "2" === e.azerite_tier && (M = z.sorted_azerite_tier_2_itemlevel.slice(0, A)), I = z.data.baseline[z.simulated_steps[z.simulated_steps.length - 1]];
      }
    } else M = "soulbinds" === l ? "nodes" === e.chart_mode ? z["sorted_data_keys_" + _(e.covenant).replace("-", "_") + "_" + e.conduit_rank].slice(0, A) : z.sorted_data_keys[e.conduit_rank].slice(0, A) : z.sorted_data_keys.slice(0, A), I = ["races", "talents"].includes(l) ? 0 : ["legendaries", "soulbind_nodes", "soulbinds", "covenants"].includes(l) ? z.data.baseline : z.data.baseline[z.simulated_steps[z.simulated_steps.length - 1]];

    for (r && (console.log(M), console.log("Baseline dps: " + I)), o.setTitle({
      text: z.title
    }, {
      text: z.subtitle
    }, !1); o.series[0];) {
    ...
    var O = void 0;
    O = "talents" === l ? M.map(function (t) {
      var o = [];

      for (var _a9 = 0; _a9 < t.length; _a9++) {
        o.push(p(e, (_a9 + 1).toString() + t[_a9], z));
      }

      return o.join("");
    }) : M.map(function (t) {
      return p(e, t, z);
    }), r && console.log(O), "highcharts" == E ? o.update({
      xAxis: {
        categories: O
      }
    }, !1) : "highcharts_old" == E && o.xAxis[0].setCategories(O, !1);
    var S = [];

    if ("azerite_traits_stacking" == l) {
      var _e6 = z.simulated_steps[0].replace("1_", "");

      S.push("3_" + _e6), S.push("2_" + _e6), S.push("1_" + _e6);
    } else S = "soulbinds" == l && "soulbinds" === e.chart_mode ? void 0 : z.simulated_steps;

    if (r && console.log("simulated_steps: " + S), S) {
      var _t4 = {};

      for (var _o9 in z.data) {
        if (z.data.hasOwnProperty(_o9)) {
          var _a10 = z.data[_o9];
          _t4[_o9] = {};
          var _r5 = I;
          "conduits" === l ? _r5 = z.data.baseline[z.covenant_mapping[_o9]] : "soulbinds" === l && "nodes" === e.chart_mode && (_r5 = z.data.baseline[e.covenant]);

          for (var _l5 = S.length - 1; _l5 >= 0; _l5--) {
            var _i5 = S[_l5];

            var _n3 = _a10.hasOwnProperty(e.covenant) ? _a10[e.covenant] : _a10;

            Number.isInteger(_n3) ? (_t4[_o9][_i5] = _n3 - _r5, _r5 = _n3) : _n3.hasOwnProperty(_i5) ? (_t4[_o9][_i5] = _n3[_i5] - _r5, _r5 = _n3[_i5]) : _t4[_o9][_i5] = 0;
          }
        }
      }
      ...
      try {
        for (var _iterator3 = S[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          for (var _o10 = 0; _o10 < M.length; _o10++) {
            ...
            _r6.push(u(e, _t4[_l6][_a11], I));
          }

          var _i6 = _a11;
          ["azerite_items_chest", "azerite_items_head", "azerite_items_shoulders", "azerite_traits_itemlevel"].indexOf(l) > -1 ? _i6 = _a11.split("_")[1] : "azerite_traits_stacking" === l && (_i6 = _a11.split("_")[0]), o.addSeries({
            data: _r6,
            name: _i6
          }, !1);
        }
      ...
      try {
        for (var _iterator4 = Object.keys(s).sort().reverse()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          for (var _t7 = 0; _t7 < M.length; _t7++) {
            var _o12 = M[_t7],
                _r7 = 0;
            z.covenant_mapping[_o12][0] === _a13 && (_r7 = z.data[_o12][e.conduit_rank]), _l7.push(_r7);
          }
      ...
      for (var _t8 = 0; _t8 < M.length; _t8++) {
        var _o13 = M[_t8],
            _a14 = z.data[_o13];
        "soulbinds" === l && (_a14 = z.data[_o13][e.conduit_rank]), H.push(_a14);
      }
    ...
    ["trinkets", "azerite_items_chest", "azerite_items_head", "azerite_items_shoulders", "azerite_traits_itemlevel"].indexOf(l) > -1 ? o.legend.title.attr({
      ...
      text: "Conduit Rank"
    }), o.redraw(), "highcharts_old" == E && o.reflow(), t.style.height = 200 + 30 * M.length + "px", "highcharts" == E && o.setSize(t.style.width, t.style.height), "wowdb" == e.tooltip_engine && setTimeout(function () {
      !function (e) {
  ...
  function g(e, t, o) {
    ...
    for (var _e7 = 0; _e7 < 3; _e7++) {
      n += Math.abs(i[_e7] - l[_e7]), s += Math.abs(l[_e7] - a[_e7]);
    }
    ...
    if (e >= d) {
      ...
      return [Math.floor(i[0] * _t9 + l[0] * (1 - _t9)), Math.floor(i[1] * _t9 + l[1] * (1 - _t9)), Math.floor(i[2] * _t9 + l[2] * (1 - _t9))];
    }
  ...
  function p(e, t, o) {
    if (r && (console.log("get_category_name"), console.log(t)), "wowhead" != e.tooltip_engine && "wowdb" != e.tooltip_engine) try {
    ...
    if (["soulbinds"].includes(e.data_type) && "soulbinds" === e.chart_mode) {
      ...
      return _a15 += o.translations[t][n[e.language]], _a15 += "</a>";
    }
    ...
    if ("wowhead" == e.tooltip_engine) {
      ...
      if (_a16.href = "https://" + ("en" === e.language ? "www" : e.language) + ".wowhead.com/", o.hasOwnProperty("item_ids") && o.item_ids.hasOwnProperty(t)) {
        if (_a16.href += "item=" + o.item_ids[t] + "/" + _(t), o.hasOwnProperty("class_id") && o.hasOwnProperty("used_azerite_traits_per_item")) {
      ...
      } else if (o.hasOwnProperty("spell_ids") && o.spell_ids.hasOwnProperty(t)) _a16.href += "spell=" + o.spell_ids[t] + "/" + _(t);else if ("talents" === e.data_type) {
        if ("0" === t[1]) return t[1];
        _a16.href += "spell=" + o.talent_data[t[0]][t[1]].spell_id;
      }

      if ("talents" === e.data_type) _a16.appendChild(document.createTextNode(t[1]));else try {
        _a16.appendChild(document.createTextNode(o.translations[t][n[e.language]]));
      } catch (l) {
        try {
          _a16.appendChild(document.createTextNode(o.languages[t][n[e.language]]));
        } catch (e) {
          _a16.appendChild(document.createTextNode(t));
        }
      }
      return _a16.outerHTML;
    }
    ...
    if ("wowdb" == e.tooltip_engine) {
      ...
      if ("talents" === e.data_type) _l9 = t[1];else try {
        _l9 = o.translations[t][n[e.language]];
      } catch (a) {
        try {
          _l9 = o.languages[t][n[e.language]];
        } catch (e) {
          _l9 = t;
        }
      }
      return _a17.appendChild(document.createTextNode(_l9)), _a17.outerHTML;
    }
  }
  ...
  function m(i) {
    if (r && console.log("update_chart_style"), "highcharts" == i.chart_engine || "highcharts_old" == i.chart_engine) {
      ...
      return _c3.chart.backgroundColor = _r8, _c3.legend.backgroundColor = _r8, _c3.legend.borderColor = _n4, _c3.legend.itemStyle.color = _s3, _c3.legend.itemHoverStyle.color = _s3, _c3.title.style.color = _s3, _c3.subtitle.style.color = _s3, _c3.tooltip.formatter = function () {
        var e = document.createElement("div");
        e.style.margin = "-4px -7px -7px -7px", e.style.padding = "3px 3px 6px 3px", e.style.backgroundColor = "transparent" !== _r8 ? _r8 : t, "highcharts_old" === i.chart_engine && (e.style.margin = "-7px");
  ...
  function f(e, t, o) {
    ...
    if (l.innerHTML = t + "%", l.classList += y(t >= 0 ? t : 3 - t), void 0 !== o) {
  ...
  function w(e, t, o, a) {
    var l = '<a href="https://';
    return "en" === e.language || "EN" === e.language ? l += "www" : l += e.language.toLowerCase(), l += ".wowhead.com/spell=", l += a.talent_data[o.slice(0, 1)][o.slice(1, 2)].spell_id, l += '"', l += ">", l += x(t, a), l += "</a>";
  }
  ...
  function x(e, t) {
    ...
    return r && console.log("Translated name: " + a), a;
  }
      ...
      for (var _iterator6 = t.sorted_data_keys[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
        ...
        if (_e13[o - 1] === a) {
          var _a18 = t.data[_e13],
              _i7 = t.data[_e13.slice(0, o - 1) + "0" + _e13.slice(o, 8)];

          l > T(_i7, _a18) && (l = T(_i7, _a18), r = _e13);
        }
      }
    } catch (err) {
      ...
      for (var _iterator7 = t.sorted_data_keys[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
        ...
        if (_e14[o - 1] === a) {
          var _a19 = t.data[_e14],
              _i8 = t.data[_e14.slice(0, o - 1) + "0" + _e14.slice(o, 8)];

          l < T(_i8, _a19) && (l = T(_i8, _a19), r = _e14);
        }
      }
    } catch (err) {
  ...
  function k(e, t) {
    ...
    for (var _i9 = 0; _i9 < o.length; _i9++) {
      var _l11 = _o17[_i9];
      var _o17 = t.data[_l11];
      a += T(t.data[_l11.slice(0, e.slice(0, 1) - 1) + "0" + _l11.slice(e.slice(0, 1), 8)], _o17);
    }
  ...
  this.init_charts = new function () {
    ...
    for (var _l12 = 0; _l12 < e.length; _l12++) {
      ...
      var _n5 = document.getElementById(e[_l12].id);
      ...
      if (_n5) {
        ...
        _n5.getAttribute("data-chart-id") ? _e15.chart_id = _n5.getAttribute("data-chart-id") : (_n5.getAttribute("data-wow-class") || (console.error("Required 'data-chart-id' or 'data-wow-class' attribute wasn't found in " + _i10 + "."), _l13 = !1), _e15.wow_class = _n5.getAttribute("data-wow-class"), _n5.getAttribute("data-wow-spec") || (console.error("Required 'data-chart-id' or 'data-wow-spec' attribute wasn't found in " + _i10 + "."), _l13 = !1), _e15.wow_spec = _n5.getAttribute("data-wow-spec"));

        var _s4 = m(_e15),
            _c4 = !1;

        if ("highcharts" == _e15.chart_engine) try {
          _c4 = Highcharts.chart(_i10, _s4);
        } catch (e) {
          return console.log("When trying to create a highcharts chart the following error occured. Did you include the necessary Highcharts scripts?"), void console.log(e);
        } else if ("highcharts_old" == _e15.chart_engine) try {
          var _e16 = _s4;
          _e16.chart.renderTo = _i10, _c4 = new Highcharts.Chart(_e16);
        } catch (e) {
          return console.log("When trying to create a highcharts_old chart the following error occured. Did you include the necessary Highcharts scripts?"), void console.log(e);
        }
        _l13 ? d(_e15) : _c4.setTitle({
